...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		switch (SONG.song.toLowerCase())
		{
			...
			case 'snusk':
				dialogue = CoolUtil.coolTextFile(Paths.txt('snusk/dialog'));
		}
		...
		switch(SONG.stage)
		{
			...
			case 'joelStage':
				{
					...
					curStage = 'joelStage';
					var bg:FlxSprite = new FlxSprite(-850,-400).loadGraphic(Paths.image('snusko'));
					bg.antialiasing = true;
					bg.scrollFactor.set(0.9,0.9);
					bg.active = false;
					bg.updateHitbox();
					...
					var lodlTex = Paths.getSparrowAtlas('lodl');

					FG = new FlxSprite(950, 550);
					FG.frames = lodlTex;
					FG.animation.addByPrefix('please', "mound", 24);
					FG.animation.play('please');
			...
			default:
			{
					defaultCamZoom = 0.9;
					curStage = 'stage';
					var bg:FlxSprite = new FlxSprite(-661.2, -204).loadGraphic(Paths.image('stageback'));
					bg.antialiasing = true;
					bg.scrollFactor.set(0.9, 0.9);
					bg.active = false;
					add(bg);
